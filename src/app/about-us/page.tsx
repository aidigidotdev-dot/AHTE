        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-[#5a5650] text-sm md:text-base leading-relaxed max-w-lg">
              {companyName} is Dubai’s premier installer of heavy-duty seamless terrazzo, commercial epoxy coatings, and premium architectural micro-cements. We bring structural durability and luxury designs to life across residential villas, commercial lobbies, and public pavilions.
            </p>
          ...
          <div className="bg-white border border-[#e1e1d7] rounded-[32px] p-8 md:p-12 shadow-sm space-y-8 relative overflow-hidden">
            ...
            <p className="text-xs text-[#5a5650] leading-relaxed">
              Founded on the principles of Italian craftsmanship and modern Gulf architecture, {companyName} specializes in formulating custom aggregates (using regional white marble, black basalt, mother-of-pearl, and colored silica glass) bound in premium cementitious or epoxy matrixes.
            </p>
            <p className="text-xs text-[#5a5650] leading-relaxed">
