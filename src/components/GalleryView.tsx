                  ...
                  <div className="pt-3.5 mt-2 border-t border-[#e1e1d7]/60 flex items-center justify-between">
                    ...
                    <div className="flex gap-1.5">
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          const message = `Check out this amazing ${proj.type} flooring project: "${proj.title}" in ${proj.location} completed by ${companyName}!`;
                      ...
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          const text = `Check out "${proj.title}" in ${proj.location} completed by ${companyName}!`;
