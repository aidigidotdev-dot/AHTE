...
export default function SeoHubView({ onNavigate }: SeoHubViewProps) {
        ...
        <div className="border-b border-[#e1e1d7] pb-12 mb-16 flex flex-col lg:flex-row justify-between items-start lg:items-end gap-6">
          <div className="max-w-3xl space-y-4">
            ...
            <p className="text-sm md:text-base text-[#5a5650] max-w-2xl leading-relaxed">
              Welcome to the {companyName} UAE engineering portal. Our master craftsmen and concrete technologists compile practical data to align with Dubai Municipality codes and BS 8204 building parameters.
            </p>
          </div>
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="bg-[#edebe1]/60 p-6 rounded-[24px] border border-[#e1e1d7] space-y-3 mt-6">
              ...
              <p className="text-[11px] text-[#5a5650] leading-relaxed">
                By maintaining these documentation logs publicly, {companyName} conforms with Google's search criteria regarding verified Experience, Expertise, and Transparency for industrial flooring categories in Dubai, outranking generic competitors who lack local engineering licenses.
              </p>
            </div>
          </div>
  ...
  "@id": "https://yourdomain.com/#corporation",
  "url": "https://yourdomain.com/",
  "telephone": "+971 58 916 3867",
  "priceRange": "AED 180 - AED 450 per Sqm",
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "Your Business Location, Al Quoz Industrial",
  ...
  "openingHoursSpecification": {
    ...
    "closes": "18:00"
                ...
                <div className="mt-4 pt-3 border-t border-white/5 flex items-center justify-between text-[#a09c94] text-[9px]">
                  ...
                  <span>CANONICAL: https://yourdomain.com/</span>
